<template>
  <header>
    <div class="header-navbar">
      <!-- div per dare un margine automatico a destra e a sinistra -->
      <div class="contenitore">
        <!-- Header navbar contatti -->
    ...
    <!-- Header navbar menu -->
    <div class="header-menu contenitore f-mode f-align-center f-justify-between">
        <!-- Header menu logo -->
        <div>
